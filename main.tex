...
\usepackage{amsmath} % ✅ Added to fix \text command issue
...
\begin{minipage}[c]{\linewidth}
    ...
    \begin{tikzpicture}
        ...
        % ✅ Filename fixed (no space, consistent case)
...
\colorbox{gray!20}{\href{https://robotechvalley.com/}{Robo Tech Valley}} \; | \; 01 March, 2025 -- 30 May, 2025 (3 months) \\
\begin{itemize}
